...
- Record trùng sẵn trên Lark không bị tự động xóa; bản có `created_time` mới nhất được chọn để
  update và duplicate được ghi log để dọn thủ công.
...
- Đã tạo và xác minh 38 bảng trên Lark test base: 12 Orders, 12 Order Items, 12 Finance, một Return
  Orders và một SKUS.
