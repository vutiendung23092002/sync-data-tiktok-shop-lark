...
### Unsettled Transactions Cty Hân Korea

Không tách theo tháng vì đây là một snapshot thay đổi liên tục.

| Môi trường | table_id |
|---|---|
| production | tblkcawPHaBJQqSp |
| test | tbl0uBF1PCAVgEne |
...
**Đã tạo đủ 39 bảng** (37 bảng nghiệp vụ ban đầu + SKUS + Unsettled Transactions). Mapping chính thức được version-control trong
...
1. Tạo 12 bảng/tháng cho Orders, 12 bảng/tháng cho Order Items, 12 bảng/tháng cho Finance, 1 bảng
   cho Return Orders, 1 bảng SKUS và 1 bảng Unsettled Transactions — cùng schema như [01-lark-schema.md](01-lark-schema.md) (dùng chức năng
...
| Unsettled Transactions | không áp dụng (1 bảng snapshot duy nhất) | không dùng `FROM/TO` |
